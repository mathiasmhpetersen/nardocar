 ...
 * LP: "BMW E91 Touring Top 3 Bestsellere" — Product Aware (CRO-optimized)
 * Target: BMW E91 Touring owners ready to buy, looking for best-selling upgrades
 *
 * STRUCTURE:
 *   1. Hero — Outcome-focused headline + social proof
 *   2. Trust bar — Trustpilot, gratis fragt, returret
 *   3. Product 1 — TA Technix Udstødningssystem (exhaust)
 *   4. Product 2 — TA-Technix Gevindundervogn (coilovers)
...
const products = [
  ...
  {
    category: "UNDERVOGN",
    name: "TA-Technix Gevindundervogn BMW E91 Touring",
    tagline: "Perfekt stance til din Touring",
    description:
      "Sænk din E91 Touring præcis som du vil — 30 til 65mm. TA-Technix gevindundervognen er designet specifikt til Touring-modellen med Twin-tube teknologi. TÜV-godkendt og med 3 års garanti til en skarp pris.",
    price: "2.602",
    oldPrice: null,
    currency: "DKK",
    badge: "BEDSTE PRIS",
    ...
    urgency: null,
    features: [
      { icon: Check, text: "Sænkning: 30-65 mm for og bag" },
      { icon: ShieldCheck, text: "TÜV-certificeret" },
      { icon: Check, text: "Twin-tube teknologi" },
      { icon: Check, text: "3 års garanti" },
    ],
    specs: [
      { label: "SÆNKNING FOR", value: "30-65 mm" },
      { label: "SÆNKNING BAG", value: "30-65 mm" },
      { label: "TÜV", value: "Ja" },
      ...
      >
        <motion.div className="absolute inset-0" style={{ y: heroImgY }}>
          <div
            ...
            style={{
              backgroundImage: "url('/images/bmw-e91-hero.jpg')",
            }}
          />
        </motion.div>
        ...
        <div className="relative z-10 container pb-20 md:pb-28">
          ...
          >
            ...
            <p className="text-foreground/65 text-lg md:text-xl max-w-xl leading-relaxed mb-6">
              Lyd, stance og kraft — de tre upgrades der forvandler enhver E91 Touring.
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <span className="text-foreground/50 text-sm">1.200+ BMW-ejere handler hos os</span>
            </div>
          </motion.div>
        </div>
      </section>
