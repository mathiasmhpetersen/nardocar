 ...
 * LP: "BMW E90 Top 3 Bestsellere" — Product Aware (CRO-optimized)
 * Target: BMW E90 owners ready to buy, looking for best-selling upgrades
 *
 * STRUCTURE:
 *   1. Hero — Outcome-focused headline + social proof
 *   2. Trust bar — Trustpilot, gratis fragt, returret
 *   3. Product 1 — TA-Technix Sports Bagpotte (exhaust)
 *   4. Product 2 — AP Gevindundervogn (coilovers)
 *   5. Product 3 — RaceChip GTS 5 (chiptuning)
...
const products = [
  {
    category: "UDSTØDNING",
    name: "TA-Technix Sports Bagpotte BMW E90/E91",
    tagline: "Sportslyd til din BMW",
    description:
      "Giv din E90 den aggressive sportslyd den mangler. TA-Technix sports bagpotte med 2x76mm runde udstødningsspidser leverer en dyb, sporty lyd der matcher BMWs karakter. Rustfrit stål med 3 års garanti.",
    price: "1.564",
    oldPrice: null,
    currency: "DKK",
    badge: null,
    ...
    urgency: null,
    features: [
      { icon: Check, text: "2x76mm runde udstødningsspidser" },
      { icon: Check, text: "3 års garanti" },
      { icon: Check, text: "Rustfrit stål" },
      { icon: Check, text: "Passer BMW 316i/318i/320i" },
    ],
    specs: [
      { label: "SPIDSER", value: "2x76mm" },
  ...
  {
    category: "UNDERVOGN",
    name: "AP Gevindundervogn BMW 3 E90/E92",
    tagline: "Stance + kørsel i perfekt balance",
    description:
      "Sænk din E90 præcis som du vil — 15 til 45mm. AP gevindundervognen giver dig det aggressive stance uden at ofre komfort på hverdagskørslen. TÜV-godkendt og med Twin-tube teknologi for optimal dæmpning.",
    price: "5.289",
    oldPrice: null,
    currency: "DKK",
    badge: null,
    ...
    urgency: null,
    features: [
      { icon: Check, text: "Sænkning: 15-45 mm for / 15-40 mm bag" },
      { icon: ShieldCheck, text: "TÜV-certificeret" },
      { icon: Check, text: "Twin-tube teknologi" },
      { icon: Check, text: "Korrosionsbeskyttet" },
    ],
    specs: [
      { label: "SÆNKNING FOR", value: "15-45 mm" },
      { label: "SÆNKNING BAG", value: "15-40 mm" },
      { label: "TÜV", value: "Ja" },
  ...
  },
  {
    ...
    description:
      "Frigør det fulde potentiale i din 335i. RaceChip GTS 5 leverer op til 30% ekstra hestekræfter med TÜV-certificering og 2 års motorgaranti. Plug & play via OBD-porten med app-styring og 7 finjusteringer.",
    price: "2.944",
    oldPrice: "3.926",
    currency: "DKK",
    badge: "SPAR 25%",
      ...
      >
        <motion.div className="absolute inset-0" style={{ y: heroImgY }}>
          <div
            ...
            style={{
              backgroundImage: "url('/images/bmw-e90-hero.jpg')",
            }}
          />
        </motion.div>
        ...
        <div className="relative z-10 container pb-20 md:pb-28">
          ...
          >
            ...
            <p className="text-foreground/65 text-lg md:text-xl max-w-xl leading-relaxed mb-6">
              Lyd, stance og kraft — de tre upgrades der forvandler enhver BMW E90.
              Valgt af tusindvis af danske BMW-ejere.
            </p>
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <span className="text-foreground/50 text-sm">1.500+ BMW-ejere handler hos os</span>
            </div>
          </motion.div>
        </div>
      </section>
