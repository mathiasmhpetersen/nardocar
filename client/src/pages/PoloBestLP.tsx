 ...
 * LP: "VW Polo Top 3 Bestsellere" — Product Aware (CRO-optimized)
 * Target: VW Polo owners ready to buy, looking for best-selling upgrades
 *
 * STRUCTURE:
 ...
 *   4. Product 2 — ST X Gevindundervogn (coilovers)
...
const products = [
  {
    category: "UDSTØDNING",
    name: "Scorpion Cat-Back System VW Polo GTI 6C",
    ...
    urgency: null,
    features: [
      { icon: Check, text: "90mm Daytona twin udstødningsspidser" },
      { icon: Check, text: "Livstidsgaranti" },
      { icon: Check, text: "T304/316 rustfrit stål" },
      { icon: Check, text: "Håndlavet i England" },
    ],
    specs: [
      { label: "RØRDIAMETER", value: "70mm / 2.75\"" },
      { label: "TIP", value: "90mm Daytona" },
      { label: "MATERIALE", value: "T304/316 stål" },
  ...
  {
    category: "UNDERVOGN",
    name: "ST X Gevindundervogn VW Polo (6R)",
    tagline: "Stance + kørsel i perfekt balance",
    description:
      "Sænk din Polo præcis som du vil — 20 til 65mm. ST X gevindundervognen med TwinTube-teknologi giver dig det aggressive stance uden at ofre komfort. TÜV-godkendt med galvaniserede støddæmpere der holder i årevis.",
    price: "6.036",
    oldPrice: null,
    currency: "DKK",
    badge: null,
    ...
    urgency: null,
    features: [
      { icon: Check, text: "Sænkning: 20-50 mm for / 40-65 mm bag" },
      { icon: ShieldCheck, text: "TÜV-certificeret" },
      { icon: Check, text: "TwinTube-teknologi" },
      { icon: Check, text: "Galvaniserede støddæmpere" },
    ],
    specs: [
      { label: "SÆNKNING FOR", value: "20-50 mm" },
      { label: "SÆNKNING BAG", value: "40-65 mm" },
      { label: "TÜV", value: "Ja" },
  ...
  {
    category: "CHIPTUNING",
    name: "RaceChip RS VW Polo V 1.2 TSI",
    tagline: "+17 HK på 15 minutter",
    description:
      "Mærk forskellen med det samme. RaceChip RS frigør op til 25% ekstra hestekræfter via plug & play — ingen mekaniker nødvendig. Tysk ingeniørkunst med 6 finjusteringer og 1 års motorgaranti.",
    price: "1.897",
    oldPrice: "2.120",
    currency: "DKK",
    badge: "SPAR 10%",
    ...
    urgency: null,
    features: [
      { icon: Check, text: "Op til +17 HK og +44 Nm" },
      ...
      >
        <motion.div className="absolute inset-0" style={{ y: heroImgY }}>
          <div
            ...
            style={{
              backgroundImage: "url('/images/polo-hero.jpg')",
            }}
          />
        </motion.div>
        ...
        <div className="relative z-10 container pb-20 md:pb-28">
          ...
          >
            ...
            <p className="text-foreground/65 text-lg md:text-xl max-w-xl leading-relaxed mb-6">
              Lyd, stance og kraft — de tre upgrades der forvandler enhver Polo.
              Valgt af tusindvis af danske Polo-ejere.
            </p>
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <span className="text-foreground/50 text-sm">1.800+ Polo-ejere handler hos os</span>
            </div>
          </motion.div>
        </div>
      </section>
